  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">Vue d'ensemble de votre programme de fidélité</p>
      </div>
          ...
          {byDayOfWeek.map(({ day, tampons }) => {
            ...
            return (
              <div key={day} className="flex-1 flex flex-col items-center gap-1.5">
                <span className="text-xs font-medium text-gray-500">{tampons > 0 ? tampons : ''}</span>
                <div
      ...
      <div className="bg-white rounded-xl shadow-sm p-5">
        ...
        {top5.length === 0 ? (
          <p className="text-sm text-gray-400 py-4 text-center">Aucun tampon distribué pour l'instant</p>
        ) : (
            ...
            {top5.map((client, i) => (
              <div key={i} className="flex items-center justify-between py-3">
                ...
                <div className="flex items-center gap-6 text-sm text-gray-500">
                  <span>
                    <strong className="text-gray-900">{client.totalStamps}</strong> tampon{client.totalStamps !== 1 ? 's' : ''}
                  </span>
